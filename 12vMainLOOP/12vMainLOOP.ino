...
float frequency = 0.0075; // speed of oscillation
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    int brightness2 = (sin(t + PI/5) + 1) / 2 * (maxBrightness - minBrightness) + minBrightness; // shifted by PI/2 to be partially out of phase
